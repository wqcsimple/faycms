...
var customize = {
    'initIframe': function(){
        $(window.frames['customize-iframe'].document).find('body').append([
            '<style>',
            '.edit-widget-container{position:relative;transition:all 0.2s linear 0s;line-height:inherit}',
            '.edit-widget-container .edit-widget-link{position:absolute;top:0;left:0;color:#fff;width:30px;height:30px;font-size:18px;z-index:5;background-color:#0085ba;border-radius:50%;text-align:center;padding:3px;border:2px solid #fff;text-shadow:0 -1px 1px #006799, 1px 0 1px #006799, 0 1px 1px #006799, -1px 0 1px #006799;box-shadow:0 2px 1px rgba(46,68,83,.15);box-sizing:border-box;display:none !important}',
            '.edit-widget-container:hover .edit-widget-link{display:inline !important}',
