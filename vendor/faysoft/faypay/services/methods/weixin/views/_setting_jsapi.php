<div class="form-field">
    ...
    <p class="description">
        ...
        格式：wx+16位数字字母组成，可登录<a href="https://mp.weixin.qq.com" target="_blank">公众平台</a>，进入开发者中心查看
    </p>
</div>
<div class="form-field">
    ...
    <p class="description">
        公众帐号Secret<br>
        格式：32位数字字母组成，可登录<a href="https://mp.weixin.qq.com" target="_blank">公众平台</a>，进入开发者中心重置
    </p>
</div>
<div class="form-field">
