...
class TradePaymentItem implements \ArrayAccess{
     ...
     */
    private $new_trade_payment = array();
    ...
    public function __get($name){
        if(array_key_exists($name, $this->new_trade_payment)){
            return $this->new_trade_payment[$name];
        }else if(array_key_exists($name, $this->trade_payment)){
    ...
    public function __set($name, $value){
        if(array_key_exists($name, $this->trade_payment)){
